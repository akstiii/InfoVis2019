...
KVS.THREEScreen.prototype = {
    ...
    init: function(a, c) {
        ...
        var f = a.max_coord.clone().sub(a.min_coord).max()
          , d = a.objectCenter()
        ...
        void 0 !== c.camera && (this.camera = c.camera);
    ...
    draw: function() {
        void 0 != this.renderer && (this.trackball.handleResize(),
...
KVS.ToTHREELine = function(a) {
    ...
    if (0 == a.colors.length)
        ...
        for (var b = 0; b < a.colors.length; b++)
            d = a.colors[b],
            c.colors.push(new THREE.Color(d[0],d[1],d[2]))
    } else
...
KVS.ToTHREEMesh = function(a) {
    ...
    if (0 == a.colors.length)
        ...
        e = a.colors[0],
        f.color = new THREE.Color(e[0],e[1],e[2]);
    else if (a.colors.length == a.coords.length)
        for (f.vertexColors = THREE.VertexColors,
        b = 0; b < d; b++) {
            var e = a.colors[c.faces[b].a]
              , g = a.colors[c.faces[b].b]
        ...
        for (f.vertexColors = THREE.FaceColors,
        b = 0; b < d; b++)
            e = a.colors[b],
            c.faces[b].color = new THREE.Color(e[0],e[1],e[2]);
    d = a.numberOfVertices();
    for (b = 0; b < d; b++)
        e = (new THREE.Vector3).fromArray(a.coords[b]),
        c.vertices.push(e);
...
KVS.ToTHREEParticleSystem = function(a) {
    ...
    return new THREE.ParticleSystem(c,f)
}
;
